...
* **[hook_civicrm_preSave_table_name](/hooks/hook_civicrm_preSave_table_name.md)** - called before writing to a database table that has an associated DAO, including core tables but not custom tables or log tables.
